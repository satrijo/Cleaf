...
?>
<div class="w-full min-h-screen flex items-center justify-center py-28 px-6 gap-10 max-w-screen-sm">
    <div class="border border-white/10 rounded-md p-5 w-full flex items-center justify-center flex-col space-y-6">
        ...
        <p class="text-white"><?= $message ? $message : 'Page not found' ?></p>
    </div>
</div>
<?php
