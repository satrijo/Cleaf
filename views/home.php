...
?>
<div class="relative isolate overflow-hidden w-full min-h-screen">
    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 text-center">
        ...
        <h1 class="text-balance text-4xl font-bold tracking-tight text-white sm:text-6xl">Data to enrich your
            online business</h1>
